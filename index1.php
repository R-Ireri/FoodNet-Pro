            ...
            <div class="container-fluid">
               <div class="row d_flex">
                  <div class=" col-md-2 col-sm-3">
                     <div class="logo">
                        <a href="index1.php">Food<span>Distibution</span></a>
                     </div>
                  </div>
...
die("Connection failed: " . $conn->connect_error);
 ...
 $email = $_SESSION['Email1'];
$sql = "SELECT * FROM `commodity` WHERE `Area_Administrator` = '$second'";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
// output data of each row
while($row = $result->fetch_assoc()) {
...
<br>
<br>
<p>To Add a Commodity, click <a href="commodity.php">HERE</a>.</p>
<br>
<br>
...
<button type="submit" name="delc1" class="send_btn">Delete Commodity</button>
            </div>
         </form>
      </div>
   </div>
