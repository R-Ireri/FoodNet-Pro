...
if (!isset($_SESSION['Email']) && !isset($_SESSION['rq'])) {
  ...
  $answer = $_SESSION['ra'];
  $query=mysqli_query($conn,"SELECT * FROM `users` WHERE `Recovery_Answer`='$answer'")or die(mysqli_error());
            ...
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage text_align_center">
                     ...
                     <h2>User Set New Password</h2>
                  </div>
               </div>
               <div class="col-md-8 offset-md-2">
                  <form id="request" class="main_form" method="POST" action="insertnewpass_u.php">
                     <div class="row">
                        <div class="col-md-12 ">
